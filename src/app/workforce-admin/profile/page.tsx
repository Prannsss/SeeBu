          ...
          {!isEditing ? (
            <div className="space-y-4 pt-2">
              ...
              <div className="pb-3 border-b border-slate-100 dark:border-slate-800 last:border-0 last:pb-0">
                ...
                <span className="block text-base text-text-main dark:text-white font-medium">Workforce Admin</span>
              </div>
            ...
            <form className="space-y-6 pt-2" onSubmit={handleSave}>
              ...
              <div className="floating-input">
                <input type="text" id="role" placeholder=" " defaultValue="Workforce Admin" />
