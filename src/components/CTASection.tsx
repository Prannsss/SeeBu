    ...
    <section className="py-20 px-6 bg-background-light dark:bg-gray-950 transition-colors">
      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-4xl lg:text-5xl font-black text-white mb-6">Be part of a <span className="font-display italic text-yellow-500">smarter</span> Cebu.</h2>
          <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">Join thousands of residents making a difference. Download the app via "Add to Home Screen" or sign up online today.</p>
