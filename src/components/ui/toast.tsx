...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "group-[.warning]:text-orange-700 group-[.warning]:hover:text-orange-900 dark:group-[.warning]:text-orange-300 dark:group-[.warning]:hover:text-orange-100",
      "group-[.destructive]:text-red-700 group-[.destructive]:hover:text-red-900 dark:group-[.destructive]:text-red-300 dark:group-[.destructive]:hover:text-red-100",
      className
    )}
    toast-close=""
    {...props}
