  ...
  return (
    <section className="py-20 bg-background-light dark:bg-gray-900 transition-colors" id="features">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div 
          ref={ref}
          className={`grid grid-cols-2 lg:grid-cols-3 gap-6 fade-in-section ${isVisible ? 'is-visible' : ''}`}
        >
          {/* Feature 1 */}
          <div className="bg-white dark:bg-gray-800 p-8 rounded-[20px] shadow-soft hover:shadow-card transition-shadow duration-300 border border-transparent hover:border-blue-50 dark:hover:border-gray-700 group">
            <div className="w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center text-primary mb-6">
              <span className="material-symbols-outlined transition-all duration-300 group-hover:scale-125 group-hover:rotate-12">timeline</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-[20px] shadow-soft hover:shadow-card transition-shadow duration-300 border border-transparent hover:border-blue-50 dark:hover:border-gray-700 group">
            <div className="w-12 h-12 rounded-xl bg-green-100 dark:bg-green-900/50 flex items-center justify-center text-green-600 mb-6">
              <span className="material-symbols-outlined transition-all duration-300 group-hover:scale-125 group-hover:-translate-y-1">location_on</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-[20px] shadow-soft hover:shadow-card transition-shadow duration-300 border border-transparent hover:border-blue-50 dark:hover:border-gray-700 group">
            <div className="w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-900/50 flex items-center justify-center text-purple-600 mb-6">
              <span className="material-symbols-outlined transition-all duration-300 group-hover:scale-125 group-hover:rotate-180">alt_route</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-[20px] shadow-soft hover:shadow-card transition-shadow duration-300 border border-transparent hover:border-blue-50 dark:hover:border-gray-700 group">
            <div className="w-12 h-12 rounded-xl bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center text-orange-600 mb-6">
              <span className="material-symbols-outlined transition-all duration-300 group-hover:scale-125 group-hover:animate-pulse">notifications_active</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-[20px] shadow-soft hover:shadow-card transition-shadow duration-300 border border-transparent hover:border-blue-50 dark:hover:border-gray-700 group">
            <div className="w-12 h-12 rounded-xl bg-teal-100 dark:bg-teal-900/50 flex items-center justify-center text-teal-600 mb-6">
              <span className="material-symbols-outlined transition-all duration-300 group-hover:scale-125 group-hover:-rotate-12">description</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-[20px] shadow-soft hover:shadow-card transition-shadow duration-300 border border-transparent hover:border-blue-50 dark:hover:border-gray-700 group">
            <div className="w-12 h-12 rounded-xl bg-red-100 dark:bg-red-900/50 flex items-center justify-center text-red-600 mb-6">
              <span className="material-symbols-outlined transition-all duration-300 group-hover:scale-125 group-hover:rotate-45">analytics</span>
            </div>
